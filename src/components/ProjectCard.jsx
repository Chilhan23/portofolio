...
const ProjectCard = ({ title, desc, url, tags, index, live = true }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "0.75rem", fontSize: "0.75rem", fontFamily: "monospace", color: hovered && live ? "#1a7aff" : "#555", transition: "color 0.3s" }}>
